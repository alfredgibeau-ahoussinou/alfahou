...
app = FastAPI(title="AlfAhou", description="IA multimédia d'Alfred Ahoussinou — FR/EN, from scratch")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
...
def generate(req: GenerateRequest):
    try:
        result = get_brain().generate(req.prompt, modality=req.modality, max_tokens=req.max_tokens)
